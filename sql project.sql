...
/* OR */
/* Unable to run this query , fitsname and last name is functionally not depended on column on group by clause*/
...
join album on album.album_id = track.album_id
join best_selling_artist bsa on bsa.artist_id = album.artist.id
group by 1,2,3,4
order by 5;
